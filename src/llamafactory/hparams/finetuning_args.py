...
class FinetuningArguments(
    ...
    drop_prob_threshold: Optional[float] = field(
        default=None,
        metadata={"help": "drop tokens with probability < drop_prob_threshold."},
    )
    drop_topk: Optional[int] = field(
        default=None,
        metadata={"help": "drop tokens not in top_k."},
    )
    use_saved_dataset: bool = field(
        default=False,
        metadata={"help": "Whether or not to use the previously saved processed dataset."},
    )
    processed_dataset_cache_path: Optional[str] = field(
        default=None,
        metadata={"help": "Path to the processed dataset cache."},
    )
